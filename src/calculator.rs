...
impl Calculator {
    pub const fn new(use_inches: bool, country: Country, under_bust: String, bust: String) -> Self {
        Self {
            use_inches,
            country,
            under_bust,
    ...
    pub fn band<'a>(&self, old_value: &'a str) -> Cow<'a, str> {
        ...
        if let Ok(under_bust) = under_bust {
            ...
            let band = (under_bust.into_raw_inch() / 2.0).round() as i32 * 2 + 4;
